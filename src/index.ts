...
const senderKeys: KeyInfo = {
  address: "X-fuji1v797jf7avasan4wrzkh2xz3qgzwfpwd56924nr",
  publicKey: "8MsaxfFNeKy4XuXz7mPrfza7QzDPs3byps4ht7Fzt9yZHb8srk",
  privateKey: "PrivateKey-NF6hVXAc82dgNuqJKHg5C38mnCyCdevLPu18y137fagSmdCRs",
};
const assetID = "2P8ExWRWiXHnTNhU1kuodLCSkSCmAzRTijBNsA8zKa7sos67hk"; // the transaction ID is used as asset ID
const friendsAddress = "X-fuji1y82dnc50xg64h9e6fh37nwtml8fpmmdf8sltmw"; // address format is Bech32
// ============ Main Part of Script ===================
